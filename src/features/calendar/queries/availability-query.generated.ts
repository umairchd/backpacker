...
import { ProductVariantMoneyFragmentDoc, LevyFieldsFragmentDoc, TravelloPriceFieldsFragmentDoc } from '../../../pages/Product/queries/product-queries.generated';
...
export type AvailabilitySlotFragment = { slotId: string, orderedId: string, remainingCount: number, totalCount: number, date?: any | null, isLastMinute: boolean, isTopDeal: boolean, startTime: string, endTime: string, title?: string | null, status: Types.SlotStatusEnum, prices: Array<{ __typename: 'Levy', label?: string | null, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { amount: number, currencyCode: string, convertedAmount?: number | null } } | { __typename: 'RecommendedRetailPrice', fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } } | { __typename: 'TravelloPrice', seatUsed: number, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } }> };

export type AvailableDateFragment = { date: any, hasAvailableSlots: boolean, slots: Array<{ slotId: string, orderedId: string, remainingCount: number, totalCount: number, date?: any | null, isLastMinute: boolean, isTopDeal: boolean, startTime: string, endTime: string, title?: string | null, status: Types.SlotStatusEnum, prices: Array<{ __typename: 'Levy', label?: string | null, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { amount: number, currencyCode: string, convertedAmount?: number | null } } | { __typename: 'RecommendedRetailPrice', fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } } | { __typename: 'TravelloPrice', seatUsed: number, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } }> }> };

export type AvailabilityFragment = { nextAvailableDate?: any | null, maximumUnitOrder?: number | null, minimumUnitOrder: number, availableDates: Array<{ date: any, hasAvailableSlots: boolean, slots: Array<{ slotId: string, orderedId: string, remainingCount: number, totalCount: number, date?: any | null, isLastMinute: boolean, isTopDeal: boolean, startTime: string, endTime: string, title?: string | null, status: Types.SlotStatusEnum, prices: Array<{ __typename: 'Levy', label?: string | null, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { amount: number, currencyCode: string, convertedAmount?: number | null } } | { __typename: 'RecommendedRetailPrice', fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } } | { __typename: 'TravelloPrice', seatUsed: number, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } }> }> }> };

export type AvailabilityV2Fragment = { resSystemType: Types.ResSystemType, slots?: Array<{ availabilitySlotKey?: string | null, availableCount?: number | null, endTime?: any | null, endTimeLocal?: string | null, isLastMinute?: boolean | null, minQuantity?: number | null, maxQuantity?: number | null, hasAvailableSlots?: boolean | null, startTimeLocal?: string | null, status?: Types.AvailabilitySlotStatusEnum | null, totalCount?: number | null, fares: Array<{ availableCount?: number | null, maxQuantity?: number | null, minQuantity?: number | null, resSystemFareTypeId: string, resSystemBookingId: string, seatUsed?: number | null, bpdFareType?: string | null, levyLabel?: string | null, price: { discountRulePrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, fareDiscountPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, recommendedRetailPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, levyPrice?: { included: boolean, value: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } | null, totalPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, totalSaving: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } }> }> | null };

export type AvailabilityV2SlotFragment = { availabilitySlotKey?: string | null, availableCount?: number | null, endTime?: any | null, endTimeLocal?: string | null, isLastMinute?: boolean | null, minQuantity?: number | null, maxQuantity?: number | null, hasAvailableSlots?: boolean | null, startTimeLocal?: string | null, status?: Types.AvailabilitySlotStatusEnum | null, totalCount?: number | null, fares: Array<{ availableCount?: number | null, maxQuantity?: number | null, minQuantity?: number | null, resSystemFareTypeId: string, resSystemBookingId: string, seatUsed?: number | null, bpdFareType?: string | null, levyLabel?: string | null, price: { discountRulePrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, fareDiscountPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, recommendedRetailPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, levyPrice?: { included: boolean, value: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } | null, totalPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, totalSaving: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } }> };

export type AvailabilitySlotFaresFragment = { availableCount?: number | null, maxQuantity?: number | null, minQuantity?: number | null, resSystemFareTypeId: string, resSystemBookingId: string, seatUsed?: number | null, bpdFareType?: string | null, levyLabel?: string | null, price: { discountRulePrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, fareDiscountPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, recommendedRetailPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, levyPrice?: { included: boolean, value: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } | null, totalPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, totalSaving: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } };

export type FareTypeFragment = { id: number, displayName?: string | null, originalName: string, resSystemFareTypeId: string, bpdFareType?: Types.BpdFareType | null };

export type NextAvailablePriceAndDateDataFragment = { productId: string, nextAvailableDate?: string | null, priceFromAvailableAt?: string | null, priceFrom?: { amount: number, currencyCode: string, convertedAmount?: number | null } | null };

export type NextAvailableDataFragment = { hasOnlyOneVariant: boolean, hasTwoOrMoreVariantProducts: boolean, availableDateAndPrice: Array<{ productId: string, nextAvailableDate?: string | null, priceFromAvailableAt?: string | null, priceFrom?: { amount: number, currencyCode: string, convertedAmount?: number | null } | null }> };

export type AvailabilityV1QueryVariables = Types.Exact<{
...
export type AvailabilityV1Query = { product?: { productId: string, availability?: { nextAvailableDate?: any | null, maximumUnitOrder?: number | null, minimumUnitOrder: number, availableDates: Array<{ date: any, hasAvailableSlots: boolean, slots: Array<{ slotId: string, orderedId: string, remainingCount: number, totalCount: number, date?: any | null, isLastMinute: boolean, isTopDeal: boolean, startTime: string, endTime: string, title?: string | null, status: Types.SlotStatusEnum, prices: Array<{ __typename: 'Levy', label?: string | null, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { amount: number, currencyCode: string, convertedAmount?: number | null } } | { __typename: 'RecommendedRetailPrice', fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } } | { __typename: 'TravelloPrice', seatUsed: number, fareType: { typeName: Types.FareTypeEnum, displayName: string }, value: { currencyCode: string, amount: number, convertedAmount?: number | null } }> }> }> } | null } | null };

export type AvailabilityV2QueryVariables = Types.Exact<{
  input: Types.AvailabilityDataFilter;
  targetCurrency: Types.Scalars['String'];
  fareTypesFilter: Types.FareTypeFilter;
}>;


export type AvailabilityV2Query = { availability?: { resSystemType: Types.ResSystemType, slots?: Array<{ availabilitySlotKey?: string | null, availableCount?: number | null, endTime?: any | null, endTimeLocal?: string | null, isLastMinute?: boolean | null, minQuantity?: number | null, maxQuantity?: number | null, hasAvailableSlots?: boolean | null, startTimeLocal?: string | null, status?: Types.AvailabilitySlotStatusEnum | null, totalCount?: number | null, fares: Array<{ availableCount?: number | null, maxQuantity?: number | null, minQuantity?: number | null, resSystemFareTypeId: string, resSystemBookingId: string, seatUsed?: number | null, bpdFareType?: string | null, levyLabel?: string | null, price: { discountRulePrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, fareDiscountPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, recommendedRetailPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, levyPrice?: { included: boolean, value: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } | null, totalPrice: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null }, totalSaving: { adjustedMoney?: { currencyCode: string, amount: number, convertedAmount?: number | null } | null } } }> }> | null } | null, fareType: Array<{ id: number, displayName?: string | null, originalName: string, resSystemFareTypeId: string, bpdFareType?: Types.BpdFareType | null } | null> };

export type NextAvailableDateAndPriceQueryVariables = Types.Exact<{
  input: Types.NextAvailableDateAndPriceFromFilter;
  targetCurrency: Types.Scalars['String'];
}>;


export type NextAvailableDateAndPriceQuery = { nextAvailableDateAndPriceFrom?: { hasOnlyOneVariant: boolean, hasTwoOrMoreVariantProducts: boolean, availableDateAndPrice: Array<{ productId: string, nextAvailableDate?: string | null, priceFromAvailableAt?: string | null, priceFrom?: { amount: number, currencyCode: string, convertedAmount?: number | null } | null }> } | null };

export const AvailabilitySlotFragmentDoc = gql`
...
${LevyFieldsFragmentDoc}
${TravelloPriceFieldsFragmentDoc}`;
export const AvailableDateFragmentDoc = gql`
...
export const AvailabilityFragmentDoc = gql`
  ...
  availableDates {
    ...
    ${AvailableDateFragmentDoc}`;
export const AvailabilitySlotFaresFragmentDoc = gql`
  ...
  levyLabel
    ...
    ${ProductVariantMoneyFragmentDoc}`;
export const AvailabilityV2SlotFragmentDoc = gql`
  ...
  totalCount
    ...
    ${AvailabilitySlotFaresFragmentDoc}`;
export const AvailabilityV2FragmentDoc = gql`
  ...
  slots {
    ...
    ${AvailabilityV2SlotFragmentDoc}`;
export const FareTypeFragmentDoc = gql`
  ...
  bpdFareType
    ...
    `;
export const NextAvailablePriceAndDateDataFragmentDoc = gql`
  ...
  priceFromAvailableAt
    ...
    `;
export const NextAvailableDataFragmentDoc = gql`
  ...
  availableDateAndPrice {
    ...
    ${NextAvailablePriceAndDateDataFragmentDoc}`;
export const AvailabilityV1Document = gql`
...
/**
 * __useAvailabilityV1Query__
 *
 * To run a query within a React component, call `useAvailabilityV1Query` and pass it any options that fit your needs.
 * When your component renders, `useAvailabilityV1Query` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAvailabilityV1Query({
 *   variables: {
 ...
 * });
 */
export function useAvailabilityV1Query(baseOptions: Apollo.QueryHookOptions<AvailabilityV1Query, AvailabilityV1QueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AvailabilityV1Query, AvailabilityV1QueryVariables>(AvailabilityV1Document, options);
      }
export function useAvailabilityV1LazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AvailabilityV1Query, AvailabilityV1QueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AvailabilityV1Query, AvailabilityV1QueryVariables>(AvailabilityV1Document, options);
        }
export type AvailabilityV1QueryHookResult = ReturnType<typeof useAvailabilityV1Query>;
export type AvailabilityV1LazyQueryHookResult = ReturnType<typeof useAvailabilityV1LazyQuery>;
export type AvailabilityV1QueryResult = Apollo.QueryResult<AvailabilityV1Query, AvailabilityV1QueryVariables>;
export const AvailabilityV2Document = gql`
  ...
  fareType(filter: $fareTypesFilter) {
    ...
    ${AvailabilityV2FragmentDoc}
${FareTypeFragmentDoc}`;

/**
 * __useAvailabilityV2Query__
 *
 * To run a query within a React component, call `useAvailabilityV2Query` and pass it any options that fit your needs.
 * When your component renders, `useAvailabilityV2Query` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAvailabilityV2Query({
 *   variables: {
 *      input: // value for 'input'
 *      targetCurrency: // value for 'targetCurrency'
 *      fareTypesFilter: // value for 'fareTypesFilter'
 *   },
 * });
 */
export function useAvailabilityV2Query(baseOptions: Apollo.QueryHookOptions<AvailabilityV2Query, AvailabilityV2QueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AvailabilityV2Query, AvailabilityV2QueryVariables>(AvailabilityV2Document, options);
      }
export function useAvailabilityV2LazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AvailabilityV2Query, AvailabilityV2QueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AvailabilityV2Query, AvailabilityV2QueryVariables>(AvailabilityV2Document, options);
        }
export type AvailabilityV2QueryHookResult = ReturnType<typeof useAvailabilityV2Query>;
export type AvailabilityV2LazyQueryHookResult = ReturnType<typeof useAvailabilityV2LazyQuery>;
export type AvailabilityV2QueryResult = Apollo.QueryResult<AvailabilityV2Query, AvailabilityV2QueryVariables>;
export const NextAvailableDateAndPriceDocument = gql`
  ...
  nextAvailableDateAndPriceFrom(input: $input) {
    ...
    ${NextAvailableDataFragmentDoc}`;

/**
 * __useNextAvailableDateAndPriceQuery__
 *
 * To run a query within a React component, call `useNextAvailableDateAndPriceQuery` and pass it any options that fit your needs.
 * When your component renders, `useNextAvailableDateAndPriceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useNextAvailableDateAndPriceQuery({
 *   variables: {
 *      input: // value for 'input'
 *      targetCurrency: // value for 'targetCurrency'
 *   },
 * });
 */
export function useNextAvailableDateAndPriceQuery(baseOptions: Apollo.QueryHookOptions<NextAvailableDateAndPriceQuery, NextAvailableDateAndPriceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<NextAvailableDateAndPriceQuery, NextAvailableDateAndPriceQueryVariables>(NextAvailableDateAndPriceDocument, options);
      }
export function useNextAvailableDateAndPriceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<NextAvailableDateAndPriceQuery, NextAvailableDateAndPriceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<NextAvailableDateAndPriceQuery, NextAvailableDateAndPriceQueryVariables>(NextAvailableDateAndPriceDocument, options);
        }
export type NextAvailableDateAndPriceQueryHookResult = ReturnType<typeof useNextAvailableDateAndPriceQuery>;
export type NextAvailableDateAndPriceLazyQueryHookResult = ReturnType<typeof useNextAvailableDateAndPriceLazyQuery>;
export type NextAvailableDateAndPriceQueryResult = Apollo.QueryResult<NextAvailableDateAndPriceQuery, NextAvailableDateAndPriceQueryVariables>;