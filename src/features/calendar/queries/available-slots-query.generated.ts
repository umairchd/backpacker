...
import { AvailabilitySlotFaresFragmentDoc } from './availability-query.generated';
...
export const AvailableSlotsDocument = gql`
    query AvailableSlots($input: AvailabilityDataFilter!, $targetCurrency: String!) {
