...
export type TextSearchQueryVariables = Types.Exact<{
  query: Types.Scalars['String'];
  limit?: Types.InputMaybe<Types.Scalars['Int']>;
  channelHost?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type TextSearchQuery = { products?: { edges?: Array<{ node: { title?: string | null, uri?: { url?: string | null } | null } } | null> | null } | null, others: { cities: Array<{ id?: string | null, name: string, uri: { url?: string | null } }>, countries: Array<{ id?: string | null, name: string, uri: { url?: string | null } }>, categories: Array<{ id?: string | null, name: string, uri: { url?: string | null } }> } };
