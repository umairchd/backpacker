...
import { ProductCardFragmentDoc } from '../components/queries/queries.generated';
 ...
 * });
 */
export function useLatestPostsQuery(baseOptions: Apollo.QueryHookOptions<LatestPostsQuery, LatestPostsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LatestPostsQuery, LatestPostsQueryVariables>(LatestPostsDocument, options);
      }
export function useLatestPostsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LatestPostsQuery, LatestPostsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LatestPostsQuery, LatestPostsQueryVariables>(LatestPostsDocument, options);
        }
...
export type LatestPostsQueryResult = Apollo.QueryResult<LatestPostsQuery, LatestPostsQueryVariables>;
export const LastMinuteProductGridDocument = gql`
...
/**
 * __useLastMinuteProductGridQuery__
 *
 * To run a query within a React component, call `useLastMinuteProductGridQuery` and pass it any options that fit your needs.
 * When your component renders, `useLastMinuteProductGridQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLastMinuteProductGridQuery({
 *   variables: {
 *      targetCurrency: // value for 'targetCurrency'
 *   },
 * });
 */
export function useLastMinuteProductGridQuery(baseOptions?: Apollo.QueryHookOptions<LastMinuteProductGridQuery, LastMinuteProductGridQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LastMinuteProductGridQuery, LastMinuteProductGridQueryVariables>(LastMinuteProductGridDocument, options);
      }
export function useLastMinuteProductGridLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LastMinuteProductGridQuery, LastMinuteProductGridQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LastMinuteProductGridQuery, LastMinuteProductGridQueryVariables>(LastMinuteProductGridDocument, options);
        }
export type LastMinuteProductGridQueryHookResult = ReturnType<typeof useLastMinuteProductGridQuery>;
export type LastMinuteProductGridLazyQueryHookResult = ReturnType<typeof useLastMinuteProductGridLazyQuery>;
export type LastMinuteProductGridQueryResult = Apollo.QueryResult<LastMinuteProductGridQuery, LastMinuteProductGridQueryVariables>;
export const LocalProductGridDocument = gql`
...
/**
 * __useLocalProductGridQuery__
 *
 * To run a query within a React component, call `useLocalProductGridQuery` and pass it any options that fit your needs.
 * When your component renders, `useLocalProductGridQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLocalProductGridQuery({
 *   variables: {
 *      targetCurrency: // value for 'targetCurrency'
 *   },
 * });
 */
export function useLocalProductGridQuery(baseOptions?: Apollo.QueryHookOptions<LocalProductGridQuery, LocalProductGridQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LocalProductGridQuery, LocalProductGridQueryVariables>(LocalProductGridDocument, options);
      }
export function useLocalProductGridLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LocalProductGridQuery, LocalProductGridQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LocalProductGridQuery, LocalProductGridQueryVariables>(LocalProductGridDocument, options);
        }
export type LocalProductGridQueryHookResult = ReturnType<typeof useLocalProductGridQuery>;
export type LocalProductGridLazyQueryHookResult = ReturnType<typeof useLocalProductGridLazyQuery>;
export type LocalProductGridQueryResult = Apollo.QueryResult<LocalProductGridQuery, LocalProductGridQueryVariables>;