...
import { RegionPageFragmentDoc } from '../../../app/sites/[site]/[theme]/region/[...slug]/queries.generated';
import { StaticPageFragmentDoc } from '../../../app/sites/[site]/[theme]/static/[...slug]/queries.generated';
import { ListPageFragmentDoc } from '../../Listing/queries/listing-queries.generated';
import { ProductPageFragmentDoc } from '../../Product/queries/product-queries.generated';
...
export type Level1PageQueryVariables = Types.Exact<{
...
export const Level1PageDocument = gql`
  ...
  page: bpd_page(host: $host, pathname: $pathname) {
    ...
    ${RegionPageFragmentDoc}
${StaticPageFragmentDoc}
${ListPageFragmentDoc}
${ProductPageFragmentDoc}`;

/**
 * __useLevel1PageQuery__
 *
 * To run a query within a React component, call `useLevel1PageQuery` and pass it any options that fit your needs.
 * When your component renders, `useLevel1PageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLevel1PageQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useLevel1PageQuery(baseOptions: Apollo.QueryHookOptions<Level1PageQuery, Level1PageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Level1PageQuery, Level1PageQueryVariables>(Level1PageDocument, options);
      }
export function useLevel1PageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Level1PageQuery, Level1PageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Level1PageQuery, Level1PageQueryVariables>(Level1PageDocument, options);
        }
export type Level1PageQueryHookResult = ReturnType<typeof useLevel1PageQuery>;
export type Level1PageLazyQueryHookResult = ReturnType<typeof useLevel1PageLazyQuery>;
export type Level1PageQueryResult = Apollo.QueryResult<Level1PageQuery, Level1PageQueryVariables>;
export const ListPageProductStatisticsDocument = gql`
...
/**
 * __useListPageProductStatisticsQuery__
 *
 * To run a query within a React component, call `useListPageProductStatisticsQuery` and pass it any options that fit your needs.
 * When your component renders, `useListPageProductStatisticsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListPageProductStatisticsQuery({
 *   variables: {
 *      filter: // value for 'filter'
 *   },
 * });
 */
export function useListPageProductStatisticsQuery(baseOptions?: Apollo.QueryHookOptions<ListPageProductStatisticsQuery, ListPageProductStatisticsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListPageProductStatisticsQuery, ListPageProductStatisticsQueryVariables>(ListPageProductStatisticsDocument, options);
      }
export function useListPageProductStatisticsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListPageProductStatisticsQuery, ListPageProductStatisticsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListPageProductStatisticsQuery, ListPageProductStatisticsQueryVariables>(ListPageProductStatisticsDocument, options);
        }
export type ListPageProductStatisticsQueryHookResult = ReturnType<typeof useListPageProductStatisticsQuery>;
export type ListPageProductStatisticsLazyQueryHookResult = ReturnType<typeof useListPageProductStatisticsLazyQuery>;
export type ListPageProductStatisticsQueryResult = Apollo.QueryResult<ListPageProductStatisticsQuery, ListPageProductStatisticsQueryVariables>;