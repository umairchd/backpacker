...
export type ProductStatisticsQuery = { productsStatistics?: { countryStatistic?: Array<{ id: string, name: string, uniqueName: string, productCount: number }> | null, cityStatistic?: Array<{ id: string, name: string, uniqueName: string, productCount: number }> | null, categoryStatistic?: Array<{ id: string, name: string, uniqueName: string, productCount: number }> | null } | null };

export type MoreActivitiesQueryVariables = Types.Exact<{
...
export const TopActivityBannerCardImageFragmentDoc = gql`
...
/**
 * __useProductStatisticsQuery__
 *
 * To run a query within a React component, call `useProductStatisticsQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductStatisticsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductStatisticsQuery({
 *   variables: {
...
export const MoreActivitiesDocument = gql`
...
/**
 * __useMoreActivitiesQuery__
 *
 * To run a query within a React component, call `useMoreActivitiesQuery` and pass it any options that fit your needs.
 * When your component renders, `useMoreActivitiesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMoreActivitiesQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useMoreActivitiesQuery(baseOptions: Apollo.QueryHookOptions<MoreActivitiesQuery, MoreActivitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MoreActivitiesQuery, MoreActivitiesQueryVariables>(MoreActivitiesDocument, options);
      }
export function useMoreActivitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MoreActivitiesQuery, MoreActivitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MoreActivitiesQuery, MoreActivitiesQueryVariables>(MoreActivitiesDocument, options);
        }
export type MoreActivitiesQueryHookResult = ReturnType<typeof useMoreActivitiesQuery>;
export type MoreActivitiesLazyQueryHookResult = ReturnType<typeof useMoreActivitiesLazyQuery>;
export type MoreActivitiesQueryResult = Apollo.QueryResult<MoreActivitiesQuery, MoreActivitiesQueryVariables>;
export const TopActivityBannerDocument = gql`
  ...
  bpd_channelByHost(host: $host) {
    ...
    ${TopActivityBannerCardImageFragmentDoc}`;

/**
 * __useTopActivityBannerQuery__
 *
 * To run a query within a React component, call `useTopActivityBannerQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopActivityBannerQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopActivityBannerQuery({
 *   variables: {
 *      host: // value for 'host'
 *   },
 * });
 */
export function useTopActivityBannerQuery(baseOptions: Apollo.QueryHookOptions<TopActivityBannerQuery, TopActivityBannerQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TopActivityBannerQuery, TopActivityBannerQueryVariables>(TopActivityBannerDocument, options);
      }
export function useTopActivityBannerLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TopActivityBannerQuery, TopActivityBannerQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TopActivityBannerQuery, TopActivityBannerQueryVariables>(TopActivityBannerDocument, options);
        }
export type TopActivityBannerQueryHookResult = ReturnType<typeof useTopActivityBannerQuery>;
export type TopActivityBannerLazyQueryHookResult = ReturnType<typeof useTopActivityBannerLazyQuery>;
export type TopActivityBannerQueryResult = Apollo.QueryResult<TopActivityBannerQuery, TopActivityBannerQueryVariables>;