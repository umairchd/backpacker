...
/**
 * __useLastMinutePageQuery__
 *
 * To run a query within a React component, call `useLastMinutePageQuery` and pass it any options that fit your needs.
 * When your component renders, `useLastMinutePageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLastMinutePageQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useLastMinutePageQuery(baseOptions: Apollo.QueryHookOptions<LastMinutePageQuery, LastMinutePageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LastMinutePageQuery, LastMinutePageQueryVariables>(LastMinutePageDocument, options);
      }
export function useLastMinutePageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LastMinutePageQuery, LastMinutePageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LastMinutePageQuery, LastMinutePageQueryVariables>(LastMinutePageDocument, options);
        }
export type LastMinutePageQueryHookResult = ReturnType<typeof useLastMinutePageQuery>;
export type LastMinutePageLazyQueryHookResult = ReturnType<typeof useLastMinutePageLazyQuery>;
export type LastMinutePageQueryResult = Apollo.QueryResult<LastMinutePageQuery, LastMinutePageQueryVariables>;