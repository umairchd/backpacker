...
import { FareTypeFragmentDoc } from '../../../features/calendar/queries/availability-query.generated';
...
export type ProductFareTypesQueryVariables = Types.Exact<{
  fareTypeFilter: Types.FareTypeFilter;
}>;


export type ProductFareTypesQuery = { fareType: Array<{ id: number, displayName?: string | null, originalName: string, resSystemFareTypeId: string, bpdFareType?: Types.BpdFareType | null } | null> };


export const ProductFareTypesDocument = gql`
...
/**
 * __useProductFareTypesQuery__
 *
 * To run a query within a React component, call `useProductFareTypesQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductFareTypesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductFareTypesQuery({
 *   variables: {
 *      fareTypeFilter: // value for 'fareTypeFilter'
 *   },
 * });
 */
export function useProductFareTypesQuery(baseOptions: Apollo.QueryHookOptions<ProductFareTypesQuery, ProductFareTypesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProductFareTypesQuery, ProductFareTypesQueryVariables>(ProductFareTypesDocument, options);
      }
export function useProductFareTypesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductFareTypesQuery, ProductFareTypesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProductFareTypesQuery, ProductFareTypesQueryVariables>(ProductFareTypesDocument, options);
        }
export type ProductFareTypesQueryHookResult = ReturnType<typeof useProductFareTypesQuery>;
export type ProductFareTypesLazyQueryHookResult = ReturnType<typeof useProductFareTypesLazyQuery>;
export type ProductFareTypesQueryResult = Apollo.QueryResult<ProductFareTypesQuery, ProductFareTypesQueryVariables>;