...
export type SavePriceFromAndNextAvailableDateMutationVariables = Types.Exact<{
  input: Types.EditProductInput;
}>;


export type SavePriceFromAndNextAvailableDateMutation = { savePriceFromAndNextAvailableDate: { id: number, productId: string } };


export const SavePriceFromAndNextAvailableDateDocument = gql`
  ...
  savePriceFromAndNextAvailableDate(input: $input) {
    ...
    `;
export type SavePriceFromAndNextAvailableDateMutationFn = Apollo.MutationFunction<SavePriceFromAndNextAvailableDateMutation, SavePriceFromAndNextAvailableDateMutationVariables>;

/**
 * __useSavePriceFromAndNextAvailableDateMutation__
 *
 * To run a mutation, you first call `useSavePriceFromAndNextAvailableDateMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSavePriceFromAndNextAvailableDateMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [savePriceFromAndNextAvailableDateMutation, { data, loading, error }] = useSavePriceFromAndNextAvailableDateMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSavePriceFromAndNextAvailableDateMutation(baseOptions?: Apollo.MutationHookOptions<SavePriceFromAndNextAvailableDateMutation, SavePriceFromAndNextAvailableDateMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SavePriceFromAndNextAvailableDateMutation, SavePriceFromAndNextAvailableDateMutationVariables>(SavePriceFromAndNextAvailableDateDocument, options);
      }
export type SavePriceFromAndNextAvailableDateMutationHookResult = ReturnType<typeof useSavePriceFromAndNextAvailableDateMutation>;
export type SavePriceFromAndNextAvailableDateMutationResult = Apollo.MutationResult<SavePriceFromAndNextAvailableDateMutation>;
export type SavePriceFromAndNextAvailableDateMutationOptions = Apollo.BaseMutationOptions<SavePriceFromAndNextAvailableDateMutation, SavePriceFromAndNextAvailableDateMutationVariables>;