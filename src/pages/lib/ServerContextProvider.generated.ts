...
import { CountryCardV2FragmentDoc, CategoryCardV2FragmentDoc, CityCardV2FragmentDoc, CategoryCardFragmentDoc } from '../components/queries/queries.generated';
...
export type SharedSiteConfigByPathnameQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
}>;


export type SharedSiteConfigByPathnameQuery = { allStatistics?: { countries?: Array<{ id: string, productCount: number, country: { id: string, name: string, uniqueName: string, uri?: { url?: string | null } | null, image?: { id: string, fileName: string, altText?: string | null, megaMenuCard?: string | null, grid624?: string | null, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null } | null } }> | null, categories?: Array<{ id: string, productCount: number, category: { id: string, name: string, uniqueName: string, uri?: { url?: string | null } | null, image?: { id: string, fileName: string, altText?: string | null, grid624?: string | null, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null } | null, metaData?: { priority?: number | null } | null } }> | null, cities?: Array<{ id: string, productCount: number, city: { id: string, name: string, uniqueName: string, uri?: { url?: string | null } | null, image?: { id: string, fileName: string, altText?: string | null, cityCard?: string | null, grid624?: string | null, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null } | null, metaData?: { priority?: number | null } | null, country?: { id: string, name: string, uniqueName: string } | null } }> | null } | null, channel: { id: string, key: string, name: string, url: string, features: Array<string>, theme: string, paymentProviders: Array<string>, categories: Array<{ id?: string | null, name: string, uniqueName: string, productCount?: number | null, uri: { url?: string | null }, image?: { id: string, fileName: string, altText?: string | null, grid624?: string | null, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null } | null }>, siteConfig: { id: string, contact_company_id?: string | null, contact_phones?: string | null, contact_mail?: string | null, contact_address?: string | null, contact_physical_address?: string | null, footer_social_links?: string | null, contact_facebook_url?: string | null, iterable_key?: string | null, is_banner_active?: boolean | null, banner_background_color?: string | null, banner_background_secondary_color?: string | null, banner_heading?: string | null, banner_text?: string | null, banner_url?: string | null, home_last_minute?: boolean | null, contact_links_phone?: string | null, contact_physical_phone?: string | null, contact_phone_us?: string | null, contact_phone_default?: string | null, tracking_google_tag_manager?: string | null, promo_title_1?: string | null, promo_title_2?: string | null, promo_title_3?: string | null, promo_title_4?: string | null, promo_title_5?: string | null, is_homepage_content_active?: boolean | null, homepage_content?: string | null, faviconImage?: { id: string, fileName: string, favicon?: string | null } | null, logoImage?: { id: string, fileName: string, logo?: string | null, logo1_5x?: string | null, logo2x?: string | null } | null, bannerIconImage?: { id: string, icon?: string | null } | null }, supportedCurrencies: Array<{ id: string, name: string, isoSymbol: string, uniRate: number, symbol: string }> } };


export const SharedSiteConfigByPathnameDocument = gql`
  ...
  channel: bpd_channelByHost(host: $host) {
    ...
    ${CountryCardV2FragmentDoc}
${CategoryCardV2FragmentDoc}
${CityCardV2FragmentDoc}
${CategoryCardFragmentDoc}`;

/**
 * __useSharedSiteConfigByPathnameQuery__
 *
 * To run a query within a React component, call `useSharedSiteConfigByPathnameQuery` and pass it any options that fit your needs.
 * When your component renders, `useSharedSiteConfigByPathnameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSharedSiteConfigByPathnameQuery({
 *   variables: {
 *      host: // value for 'host'
 *   },
 * });
 */
export function useSharedSiteConfigByPathnameQuery(baseOptions: Apollo.QueryHookOptions<SharedSiteConfigByPathnameQuery, SharedSiteConfigByPathnameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SharedSiteConfigByPathnameQuery, SharedSiteConfigByPathnameQueryVariables>(SharedSiteConfigByPathnameDocument, options);
      }
export function useSharedSiteConfigByPathnameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SharedSiteConfigByPathnameQuery, SharedSiteConfigByPathnameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SharedSiteConfigByPathnameQuery, SharedSiteConfigByPathnameQueryVariables>(SharedSiteConfigByPathnameDocument, options);
        }
export type SharedSiteConfigByPathnameQueryHookResult = ReturnType<typeof useSharedSiteConfigByPathnameQuery>;
export type SharedSiteConfigByPathnameLazyQueryHookResult = ReturnType<typeof useSharedSiteConfigByPathnameLazyQuery>;
export type SharedSiteConfigByPathnameQueryResult = Apollo.QueryResult<SharedSiteConfigByPathnameQuery, SharedSiteConfigByPathnameQueryVariables>;