...
export type BookingParticipantDetailFragment = { bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, lastName?: string | null, id: number };

export type BookingInfoFragment = { availabilitySlotKey?: string | null, bookingId: number, bookingUid: string, bookingStatus: Types.BookingStatus, bookingType?: Types.BookingType | null, departureDate: any, productId: string, userId: string, participantDetails?: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, lastName?: string | null, id: number } | null> | null };
...
export type BookingQuery = { booking: { availabilitySlotKey?: string | null, bookingId: number, bookingUid: string, bookingStatus: Types.BookingStatus, bookingType?: Types.BookingType | null, departureDate: any, productId: string, userId: string, participantDetails?: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, lastName?: string | null, id: number } | null> | null } };

export type CreateBookingMutationVariables = Types.Exact<{
  input: Types.BookingDataInput;
}>;


export type CreateBookingMutation = { createBooking: { availabilitySlotKey?: string | null, bookingId: number, bookingUid: string, bookingStatus: Types.BookingStatus, bookingType?: Types.BookingType | null, departureDate: any, productId: string, userId: string, participantDetails?: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, lastName?: string | null, id: number } | null> | null } };

export type UpdateBookingMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  input: Types.UpdateBookingDataInput;
}>;


export type UpdateBookingMutation = { updateBooking: { data?: { availabilitySlotKey?: string | null, bookingId: number, bookingUid: string, bookingStatus: Types.BookingStatus, bookingType?: Types.BookingType | null, departureDate: any, productId: string, userId: string, participantDetails?: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, lastName?: string | null, id: number } | null> | null } | null } };

export const BookingParticipantDetailFragmentDoc = gql`
  ...
  id
    ...
    `;
export const BookingInfoFragmentDoc = gql`
  ...
  participantDetails {
    ...
    ${BookingParticipantDetailFragmentDoc}`;
