...
export type BookingPricingDetailsFragment = { commission: number, currency: string, discount?: number | null, discountType?: Types.DiscountType | null, id?: number | null, recommendedRetailPrice: number, totalOrderPrice: number, fareTypesToBook: Array<{ numberOfSeats: number, resSystemFareTypeId: string }>, promocode?: { name: string, discountAmount: number } | null };

export type BookingPricingQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BookingPricingQuery = { bookingPricing: { commission: number, currency: string, discount?: number | null, discountType?: Types.DiscountType | null, id?: number | null, recommendedRetailPrice: number, totalOrderPrice: number, fareTypesToBook: Array<{ numberOfSeats: number, resSystemFareTypeId: string }>, promocode?: { name: string, discountAmount: number } | null } };

export const BookingPricingDetailsFragmentDoc = gql`
  ...
  promocode {
    ...
    `;
export const BookingPricingDocument = gql`
    query BookingPricing($bookingUid: String) {
  bookingPricing(bookingUid: $bookingUid) {
    ...BookingPricingDetails
  }
}
    ${BookingPricingDetailsFragmentDoc}`;

/**
 * __useBookingPricingQuery__
 *
 * To run a query within a React component, call `useBookingPricingQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookingPricingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookingPricingQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useBookingPricingQuery(baseOptions?: Apollo.QueryHookOptions<BookingPricingQuery, BookingPricingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BookingPricingQuery, BookingPricingQueryVariables>(BookingPricingDocument, options);
      }
export function useBookingPricingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BookingPricingQuery, BookingPricingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BookingPricingQuery, BookingPricingQueryVariables>(BookingPricingDocument, options);
        }
export type BookingPricingQueryHookResult = ReturnType<typeof useBookingPricingQuery>;
export type BookingPricingLazyQueryHookResult = ReturnType<typeof useBookingPricingLazyQuery>;
export type BookingPricingQueryResult = Apollo.QueryResult<BookingPricingQuery, BookingPricingQueryVariables>;