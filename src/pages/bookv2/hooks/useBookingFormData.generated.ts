...
export type ValidateAvailabilityAndPricingQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type ValidateAvailabilityAndPricingQuery = { validateAvailabilityAndPricing: boolean };

export type BookingContactInfoValuesFragment = { email: string, firstName: string, id: number, lastName: string, phone: string };

export type BookingContactInfoQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BookingContactInfoQuery = { bookingContactInfo?: { email: string, firstName: string, id: number, lastName: string, phone: string } | null };

export type BookingParticipantDetailsValuesFragment = { bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, id: number, lastName?: string | null };

export type BookingParticipantDetailsQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BookingParticipantDetailsQuery = { bookingParticipantDetails?: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, id: number, lastName?: string | null } | null> | null };

export type BookingExtraInfoQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BookingExtraInfoQuery = { bookingExtraInfo?: { message?: string | null } | null };

export type CreateBookingContactInfoMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  input: Types.BookingContactInfoInput;
}>;


export type CreateBookingContactInfoMutation = { bookingContactInfo: { email: string, firstName: string, id: number, lastName: string, phone: string } };

export type CreateBookingExtraInfoMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  message: Types.Scalars['String'];
}>;


export type CreateBookingExtraInfoMutation = { bookingExtraInfo: { message?: string | null } };

export type UpdateBookingContactInfoMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  input: Types.BookingContactInfoInput;
}>;


export type UpdateBookingContactInfoMutation = { updateBookingContactInfo: { email: string, firstName: string, id: number, lastName: string, phone: string } };

export type UpdateBookingParticipantDetailsMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  input: Array<Types.BookingParticipantDetailsInput> | Types.BookingParticipantDetailsInput;
}>;


export type UpdateBookingParticipantDetailsMutation = { updateBookingParticipantDetails: Array<{ bookingFareTypeId: number, bookingFareTypeName: string, firstName?: string | null, id: number, lastName?: string | null }> };

export type UpdateBookingExtraInfoMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  message: Types.Scalars['String'];
}>;


export type UpdateBookingExtraInfoMutation = { updateBookingExtraInfo: { message?: string | null } };

export type UpdateBookingPickupMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  input: Types.BookingPickupInput;
}>;


export type UpdateBookingPickupMutation = { bookingPickup: { name?: string | null, address?: string | null, pickupId?: string | null, offset?: number | null, additionalNotes?: string | null } };

export const BookingContactInfoValuesFragmentDoc = gql`
  ...
  phone
    ...
    `;
export const BookingParticipantDetailsValuesFragmentDoc = gql`
  ...
  lastName
    ...
    `;
export const ValidateAvailabilityAndPricingDocument = gql`
...
/**
 * __useValidateAvailabilityAndPricingQuery__
 *
 * To run a query within a React component, call `useValidateAvailabilityAndPricingQuery` and pass it any options that fit your needs.
 * When your component renders, `useValidateAvailabilityAndPricingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useValidateAvailabilityAndPricingQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useValidateAvailabilityAndPricingQuery(baseOptions?: Apollo.QueryHookOptions<ValidateAvailabilityAndPricingQuery, ValidateAvailabilityAndPricingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ValidateAvailabilityAndPricingQuery, ValidateAvailabilityAndPricingQueryVariables>(ValidateAvailabilityAndPricingDocument, options);
      }
export function useValidateAvailabilityAndPricingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ValidateAvailabilityAndPricingQuery, ValidateAvailabilityAndPricingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ValidateAvailabilityAndPricingQuery, ValidateAvailabilityAndPricingQueryVariables>(ValidateAvailabilityAndPricingDocument, options);
        }
export type ValidateAvailabilityAndPricingQueryHookResult = ReturnType<typeof useValidateAvailabilityAndPricingQuery>;
export type ValidateAvailabilityAndPricingLazyQueryHookResult = ReturnType<typeof useValidateAvailabilityAndPricingLazyQuery>;
export type ValidateAvailabilityAndPricingQueryResult = Apollo.QueryResult<ValidateAvailabilityAndPricingQuery, ValidateAvailabilityAndPricingQueryVariables>;
export const BookingContactInfoDocument = gql`
    query BookingContactInfo($bookingUid: String) {
  bookingContactInfo(bookingUid: $bookingUid) {
    ...BookingContactInfoValues
  }
}
    ${BookingContactInfoValuesFragmentDoc}`;

/**
 * __useBookingContactInfoQuery__
 *
 * To run a query within a React component, call `useBookingContactInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookingContactInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookingContactInfoQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useBookingContactInfoQuery(baseOptions?: Apollo.QueryHookOptions<BookingContactInfoQuery, BookingContactInfoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BookingContactInfoQuery, BookingContactInfoQueryVariables>(BookingContactInfoDocument, options);
      }
export function useBookingContactInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BookingContactInfoQuery, BookingContactInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BookingContactInfoQuery, BookingContactInfoQueryVariables>(BookingContactInfoDocument, options);
        }
export type BookingContactInfoQueryHookResult = ReturnType<typeof useBookingContactInfoQuery>;
export type BookingContactInfoLazyQueryHookResult = ReturnType<typeof useBookingContactInfoLazyQuery>;
export type BookingContactInfoQueryResult = Apollo.QueryResult<BookingContactInfoQuery, BookingContactInfoQueryVariables>;
export const BookingParticipantDetailsDocument = gql`
  ...
  bookingParticipantDetails(bookingUid: $bookingUid) {
    ...
    ${BookingParticipantDetailsValuesFragmentDoc}`;

/**
 * __useBookingParticipantDetailsQuery__
 *
 * To run a query within a React component, call `useBookingParticipantDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookingParticipantDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookingParticipantDetailsQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useBookingParticipantDetailsQuery(baseOptions?: Apollo.QueryHookOptions<BookingParticipantDetailsQuery, BookingParticipantDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BookingParticipantDetailsQuery, BookingParticipantDetailsQueryVariables>(BookingParticipantDetailsDocument, options);
      }
export function useBookingParticipantDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BookingParticipantDetailsQuery, BookingParticipantDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BookingParticipantDetailsQuery, BookingParticipantDetailsQueryVariables>(BookingParticipantDetailsDocument, options);
        }
export type BookingParticipantDetailsQueryHookResult = ReturnType<typeof useBookingParticipantDetailsQuery>;
export type BookingParticipantDetailsLazyQueryHookResult = ReturnType<typeof useBookingParticipantDetailsLazyQuery>;
export type BookingParticipantDetailsQueryResult = Apollo.QueryResult<BookingParticipantDetailsQuery, BookingParticipantDetailsQueryVariables>;
export const BookingExtraInfoDocument = gql`
...
/**
 * __useBookingExtraInfoQuery__
 *
 * To run a query within a React component, call `useBookingExtraInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookingExtraInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookingExtraInfoQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useBookingExtraInfoQuery(baseOptions?: Apollo.QueryHookOptions<BookingExtraInfoQuery, BookingExtraInfoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BookingExtraInfoQuery, BookingExtraInfoQueryVariables>(BookingExtraInfoDocument, options);
      }
export function useBookingExtraInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BookingExtraInfoQuery, BookingExtraInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BookingExtraInfoQuery, BookingExtraInfoQueryVariables>(BookingExtraInfoDocument, options);
        }
export type BookingExtraInfoQueryHookResult = ReturnType<typeof useBookingExtraInfoQuery>;
export type BookingExtraInfoLazyQueryHookResult = ReturnType<typeof useBookingExtraInfoLazyQuery>;
export type BookingExtraInfoQueryResult = Apollo.QueryResult<BookingExtraInfoQuery, BookingExtraInfoQueryVariables>;
export const CreateBookingContactInfoDocument = gql`
    mutation CreateBookingContactInfo($bookingUid: String, $input: BookingContactInfoInput!) {
  bookingContactInfo(bookingUid: $bookingUid, input: $input) {
    ...
    `;
export type CreateBookingContactInfoMutationFn = Apollo.MutationFunction<CreateBookingContactInfoMutation, CreateBookingContactInfoMutationVariables>;

/**
 * __useCreateBookingContactInfoMutation__
 *
 * To run a mutation, you first call `useCreateBookingContactInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBookingContactInfoMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createBookingContactInfoMutation, { data, loading, error }] = useCreateBookingContactInfoMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 ...
 * });
 */
export function useCreateBookingContactInfoMutation(baseOptions?: Apollo.MutationHookOptions<CreateBookingContactInfoMutation, CreateBookingContactInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateBookingContactInfoMutation, CreateBookingContactInfoMutationVariables>(CreateBookingContactInfoDocument, options);
      }
export type CreateBookingContactInfoMutationHookResult = ReturnType<typeof useCreateBookingContactInfoMutation>;
export type CreateBookingContactInfoMutationResult = Apollo.MutationResult<CreateBookingContactInfoMutation>;
export type CreateBookingContactInfoMutationOptions = Apollo.BaseMutationOptions<CreateBookingContactInfoMutation, CreateBookingContactInfoMutationVariables>;
export const CreateBookingExtraInfoDocument = gql`
  ...
  bookingExtraInfo(bookingUid: $bookingUid, message: $message) {
    ...
    `;
export type CreateBookingExtraInfoMutationFn = Apollo.MutationFunction<CreateBookingExtraInfoMutation, CreateBookingExtraInfoMutationVariables>;

/**
 * __useCreateBookingExtraInfoMutation__
 *
 * To run a mutation, you first call `useCreateBookingExtraInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBookingExtraInfoMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createBookingExtraInfoMutation, { data, loading, error }] = useCreateBookingExtraInfoMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 ...
 * });
 */
export function useCreateBookingExtraInfoMutation(baseOptions?: Apollo.MutationHookOptions<CreateBookingExtraInfoMutation, CreateBookingExtraInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateBookingExtraInfoMutation, CreateBookingExtraInfoMutationVariables>(CreateBookingExtraInfoDocument, options);
      }
export type CreateBookingExtraInfoMutationHookResult = ReturnType<typeof useCreateBookingExtraInfoMutation>;
export type CreateBookingExtraInfoMutationResult = Apollo.MutationResult<CreateBookingExtraInfoMutation>;
export type CreateBookingExtraInfoMutationOptions = Apollo.BaseMutationOptions<CreateBookingExtraInfoMutation, CreateBookingExtraInfoMutationVariables>;
export const UpdateBookingContactInfoDocument = gql`
    mutation UpdateBookingContactInfo($bookingUid: String, $input: BookingContactInfoInput!) {
  updateBookingContactInfo(bookingUid: $bookingUid, input: $input) {
    ...
    `;
export type UpdateBookingContactInfoMutationFn = Apollo.MutationFunction<UpdateBookingContactInfoMutation, UpdateBookingContactInfoMutationVariables>;

/**
 * __useUpdateBookingContactInfoMutation__
 *
 * To run a mutation, you first call `useUpdateBookingContactInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBookingContactInfoMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBookingContactInfoMutation, { data, loading, error }] = useUpdateBookingContactInfoMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBookingContactInfoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateBookingContactInfoMutation, UpdateBookingContactInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateBookingContactInfoMutation, UpdateBookingContactInfoMutationVariables>(UpdateBookingContactInfoDocument, options);
      }
export type UpdateBookingContactInfoMutationHookResult = ReturnType<typeof useUpdateBookingContactInfoMutation>;
export type UpdateBookingContactInfoMutationResult = Apollo.MutationResult<UpdateBookingContactInfoMutation>;
export type UpdateBookingContactInfoMutationOptions = Apollo.BaseMutationOptions<UpdateBookingContactInfoMutation, UpdateBookingContactInfoMutationVariables>;
export const UpdateBookingParticipantDetailsDocument = gql`
    mutation UpdateBookingParticipantDetails($bookingUid: String, $input: [BookingParticipantDetailsInput!]!) {
  updateBookingParticipantDetails(bookingUid: $bookingUid, input: $input) {
    ...
    `;
export type UpdateBookingParticipantDetailsMutationFn = Apollo.MutationFunction<UpdateBookingParticipantDetailsMutation, UpdateBookingParticipantDetailsMutationVariables>;

/**
 * __useUpdateBookingParticipantDetailsMutation__
 *
 * To run a mutation, you first call `useUpdateBookingParticipantDetailsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBookingParticipantDetailsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBookingParticipantDetailsMutation, { data, loading, error }] = useUpdateBookingParticipantDetailsMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBookingParticipantDetailsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateBookingParticipantDetailsMutation, UpdateBookingParticipantDetailsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateBookingParticipantDetailsMutation, UpdateBookingParticipantDetailsMutationVariables>(UpdateBookingParticipantDetailsDocument, options);
      }
export type UpdateBookingParticipantDetailsMutationHookResult = ReturnType<typeof useUpdateBookingParticipantDetailsMutation>;
export type UpdateBookingParticipantDetailsMutationResult = Apollo.MutationResult<UpdateBookingParticipantDetailsMutation>;
export type UpdateBookingParticipantDetailsMutationOptions = Apollo.BaseMutationOptions<UpdateBookingParticipantDetailsMutation, UpdateBookingParticipantDetailsMutationVariables>;
export const UpdateBookingExtraInfoDocument = gql`
  ...
  updateBookingExtraInfo(bookingUid: $bookingUid, message: $message) {
    ...
    `;
export type UpdateBookingExtraInfoMutationFn = Apollo.MutationFunction<UpdateBookingExtraInfoMutation, UpdateBookingExtraInfoMutationVariables>;

/**
 * __useUpdateBookingExtraInfoMutation__
 *
 * To run a mutation, you first call `useUpdateBookingExtraInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBookingExtraInfoMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBookingExtraInfoMutation, { data, loading, error }] = useUpdateBookingExtraInfoMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *      message: // value for 'message'
 *   },
 * });
 */
export function useUpdateBookingExtraInfoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateBookingExtraInfoMutation, UpdateBookingExtraInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateBookingExtraInfoMutation, UpdateBookingExtraInfoMutationVariables>(UpdateBookingExtraInfoDocument, options);
      }
export type UpdateBookingExtraInfoMutationHookResult = ReturnType<typeof useUpdateBookingExtraInfoMutation>;
export type UpdateBookingExtraInfoMutationResult = Apollo.MutationResult<UpdateBookingExtraInfoMutation>;
export type UpdateBookingExtraInfoMutationOptions = Apollo.BaseMutationOptions<UpdateBookingExtraInfoMutation, UpdateBookingExtraInfoMutationVariables>;
export const UpdateBookingPickupDocument = gql`
    mutation UpdateBookingPickup($bookingUid: String, $input: BookingPickupInput!) {
  bookingPickup(bookingUid: $bookingUid, input: $input) {
    ...
    `;
export type UpdateBookingPickupMutationFn = Apollo.MutationFunction<UpdateBookingPickupMutation, UpdateBookingPickupMutationVariables>;

/**
 * __useUpdateBookingPickupMutation__
 *
 * To run a mutation, you first call `useUpdateBookingPickupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBookingPickupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateBookingPickupMutation, { data, loading, error }] = useUpdateBookingPickupMutation({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateBookingPickupMutation(baseOptions?: Apollo.MutationHookOptions<UpdateBookingPickupMutation, UpdateBookingPickupMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateBookingPickupMutation, UpdateBookingPickupMutationVariables>(UpdateBookingPickupDocument, options);
      }
export type UpdateBookingPickupMutationHookResult = ReturnType<typeof useUpdateBookingPickupMutation>;
export type UpdateBookingPickupMutationResult = Apollo.MutationResult<UpdateBookingPickupMutation>;
export type UpdateBookingPickupMutationOptions = Apollo.BaseMutationOptions<UpdateBookingPickupMutation, UpdateBookingPickupMutationVariables>;