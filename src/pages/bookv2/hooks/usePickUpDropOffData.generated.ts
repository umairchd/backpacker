...
export type PickUpDropOffFragment = { address: string, id?: string | null, isDefault?: boolean | null, name: string, offset?: number | null, type: Types.PickupDropOffType };

export type SlotWithPickUpDropOffQueryVariables = Types.Exact<{
  input: Types.AvailabilityDataFilter;
}>;


export type SlotWithPickUpDropOffQuery = { availability?: { slots?: Array<{ availabilitySlotKey?: string | null, pickupDropOffs?: Array<{ address: string, id?: string | null, isDefault?: boolean | null, name: string, offset?: number | null, type: Types.PickupDropOffType } | null> | null }> | null } | null };

export const PickUpDropOffFragmentDoc = gql`
  ...
  type
    ...
    `;
export const SlotWithPickUpDropOffDocument = gql`
  ...
  availability(input: $input) {
    ...
    ${PickUpDropOffFragmentDoc}`;

/**
 * __useSlotWithPickUpDropOffQuery__
 *
 * To run a query within a React component, call `useSlotWithPickUpDropOffQuery` and pass it any options that fit your needs.
 * When your component renders, `useSlotWithPickUpDropOffQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSlotWithPickUpDropOffQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSlotWithPickUpDropOffQuery(baseOptions: Apollo.QueryHookOptions<SlotWithPickUpDropOffQuery, SlotWithPickUpDropOffQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SlotWithPickUpDropOffQuery, SlotWithPickUpDropOffQueryVariables>(SlotWithPickUpDropOffDocument, options);
      }
export function useSlotWithPickUpDropOffLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SlotWithPickUpDropOffQuery, SlotWithPickUpDropOffQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SlotWithPickUpDropOffQuery, SlotWithPickUpDropOffQueryVariables>(SlotWithPickUpDropOffDocument, options);
        }
export type SlotWithPickUpDropOffQueryHookResult = ReturnType<typeof useSlotWithPickUpDropOffQuery>;
export type SlotWithPickUpDropOffLazyQueryHookResult = ReturnType<typeof useSlotWithPickUpDropOffLazyQuery>;
export type SlotWithPickUpDropOffQueryResult = Apollo.QueryResult<SlotWithPickUpDropOffQuery, SlotWithPickUpDropOffQueryVariables>;