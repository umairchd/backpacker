...
export type ApplyBookingPromocodeMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  promocode: Types.Scalars['String'];
}>;


export type ApplyBookingPromocodeMutation = { applyBookingPromocode: { __typename: 'BookingPromocodeErrorPayload', error?: string | null, success: boolean } | { __typename: 'BookingPromocodeSuccessPayload', promocodeName?: string | null, success: boolean } };


export const ApplyBookingPromocodeDocument = gql`
  ...
  applyBookingPromocode(bookingUid: $bookingUid, promocode: $promocode) {
    ...
    `;
export type ApplyBookingPromocodeMutationFn = Apollo.MutationFunction<ApplyBookingPromocodeMutation, ApplyBookingPromocodeMutationVariables>;

/**
 * __useApplyBookingPromocodeMutation__
 *
 * To run a mutation, you first call `useApplyBookingPromocodeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useApplyBookingPromocodeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [applyBookingPromocodeMutation, { data, loading, error }] = useApplyBookingPromocodeMutation({
 *   variables: {
 ...
 * });
 */
export function useApplyBookingPromocodeMutation(baseOptions?: Apollo.MutationHookOptions<ApplyBookingPromocodeMutation, ApplyBookingPromocodeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ApplyBookingPromocodeMutation, ApplyBookingPromocodeMutationVariables>(ApplyBookingPromocodeDocument, options);
      }
export type ApplyBookingPromocodeMutationHookResult = ReturnType<typeof useApplyBookingPromocodeMutation>;
export type ApplyBookingPromocodeMutationResult = Apollo.MutationResult<ApplyBookingPromocodeMutation>;
export type ApplyBookingPromocodeMutationOptions = Apollo.BaseMutationOptions<ApplyBookingPromocodeMutation, ApplyBookingPromocodeMutationVariables>;