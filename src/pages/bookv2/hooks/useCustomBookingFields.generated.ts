...
export type CustomBookingFieldFragment = { fieldType: Types.CustomBookingFieldType, fieldTypeDataForeignId?: number | null, id: number, placeholder?: string | null, productId: string, label?: string | null, publishedLevel: Types.VisibilityLevel, requiredLevel: Types.VisibilityLevel };

export type CustomBookingFieldStringTypeConfigFragment = { id: number, maxLength?: number | null, regex?: string | null, shortDescription: string };

export type CustomBookingFieldMapTypeConfigFragment = { groupId: number, id: number, label?: string | null, resSystemAnswerId?: string | null };

export type CustomBookingFieldsQueryVariables = Types.Exact<{
  filter: Types.CustomBookingFieldsFilter;
}>;


export type CustomBookingFieldsQuery = { customBookingFields: Array<{ fieldType: Types.CustomBookingFieldType, fieldTypeDataForeignId?: number | null, id: number, placeholder?: string | null, productId: string, label?: string | null, publishedLevel: Types.VisibilityLevel, requiredLevel: Types.VisibilityLevel }> };

export type CustomBookingFieldStringTypeConfigsQueryVariables = Types.Exact<{
  filter: Types.CustomBookingFieldsFilter;
}>;


export type CustomBookingFieldStringTypeConfigsQuery = { customBookingFieldsStringTypeConfiguration: Array<{ id: number, maxLength?: number | null, regex?: string | null, shortDescription: string }> };

export type CustomBookingFieldMapTypeConfigsQueryVariables = Types.Exact<{
  filter: Types.CustomBookingFieldsFilter;
}>;


export type CustomBookingFieldMapTypeConfigsQuery = { customBookingFieldsMapTypeConfiguration: Array<{ groupId: number, id: number, label?: string | null, resSystemAnswerId?: string | null }> };

export const CustomBookingFieldFragmentDoc = gql`
  ...
  requiredLevel
    ...
    `;
export const CustomBookingFieldStringTypeConfigFragmentDoc = gql`
  ...
  shortDescription
    ...
    `;
export const CustomBookingFieldMapTypeConfigFragmentDoc = gql`
  ...
  resSystemAnswerId
    ...
    `;
export const CustomBookingFieldsDocument = gql`
    query CustomBookingFields($filter: CustomBookingFieldsFilter!) {
  customBookingFields(filter: $filter) {
    ...CustomBookingField
  }
}
    ${CustomBookingFieldFragmentDoc}`;

/**
 * __useCustomBookingFieldsQuery__
 *
 * To run a query within a React component, call `useCustomBookingFieldsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCustomBookingFieldsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomBookingFieldsQuery({
 *   variables: {
 *      filter: // value for 'filter'
 *   },
 * });
 */
export function useCustomBookingFieldsQuery(baseOptions: Apollo.QueryHookOptions<CustomBookingFieldsQuery, CustomBookingFieldsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CustomBookingFieldsQuery, CustomBookingFieldsQueryVariables>(CustomBookingFieldsDocument, options);
      }
export function useCustomBookingFieldsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CustomBookingFieldsQuery, CustomBookingFieldsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CustomBookingFieldsQuery, CustomBookingFieldsQueryVariables>(CustomBookingFieldsDocument, options);
        }
export type CustomBookingFieldsQueryHookResult = ReturnType<typeof useCustomBookingFieldsQuery>;
export type CustomBookingFieldsLazyQueryHookResult = ReturnType<typeof useCustomBookingFieldsLazyQuery>;
export type CustomBookingFieldsQueryResult = Apollo.QueryResult<CustomBookingFieldsQuery, CustomBookingFieldsQueryVariables>;
export const CustomBookingFieldStringTypeConfigsDocument = gql`
    query CustomBookingFieldStringTypeConfigs($filter: CustomBookingFieldsFilter!) {
  customBookingFieldsStringTypeConfiguration(filter: $filter) {
    ...CustomBookingFieldStringTypeConfig
  }
}
    ${CustomBookingFieldStringTypeConfigFragmentDoc}`;

/**
 * __useCustomBookingFieldStringTypeConfigsQuery__
 *
 * To run a query within a React component, call `useCustomBookingFieldStringTypeConfigsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCustomBookingFieldStringTypeConfigsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomBookingFieldStringTypeConfigsQuery({
 *   variables: {
 *      filter: // value for 'filter'
 *   },
 * });
 */
export function useCustomBookingFieldStringTypeConfigsQuery(baseOptions: Apollo.QueryHookOptions<CustomBookingFieldStringTypeConfigsQuery, CustomBookingFieldStringTypeConfigsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CustomBookingFieldStringTypeConfigsQuery, CustomBookingFieldStringTypeConfigsQueryVariables>(CustomBookingFieldStringTypeConfigsDocument, options);
      }
export function useCustomBookingFieldStringTypeConfigsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CustomBookingFieldStringTypeConfigsQuery, CustomBookingFieldStringTypeConfigsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CustomBookingFieldStringTypeConfigsQuery, CustomBookingFieldStringTypeConfigsQueryVariables>(CustomBookingFieldStringTypeConfigsDocument, options);
        }
export type CustomBookingFieldStringTypeConfigsQueryHookResult = ReturnType<typeof useCustomBookingFieldStringTypeConfigsQuery>;
export type CustomBookingFieldStringTypeConfigsLazyQueryHookResult = ReturnType<typeof useCustomBookingFieldStringTypeConfigsLazyQuery>;
export type CustomBookingFieldStringTypeConfigsQueryResult = Apollo.QueryResult<CustomBookingFieldStringTypeConfigsQuery, CustomBookingFieldStringTypeConfigsQueryVariables>;
export const CustomBookingFieldMapTypeConfigsDocument = gql`
  ...
  customBookingFieldsMapTypeConfiguration(filter: $filter) {
    ...
    ${CustomBookingFieldMapTypeConfigFragmentDoc}`;

/**
 * __useCustomBookingFieldMapTypeConfigsQuery__
 *
 * To run a query within a React component, call `useCustomBookingFieldMapTypeConfigsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCustomBookingFieldMapTypeConfigsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCustomBookingFieldMapTypeConfigsQuery({
 *   variables: {
 *      filter: // value for 'filter'
 *   },
 * });
 */
export function useCustomBookingFieldMapTypeConfigsQuery(baseOptions: Apollo.QueryHookOptions<CustomBookingFieldMapTypeConfigsQuery, CustomBookingFieldMapTypeConfigsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CustomBookingFieldMapTypeConfigsQuery, CustomBookingFieldMapTypeConfigsQueryVariables>(CustomBookingFieldMapTypeConfigsDocument, options);
      }
export function useCustomBookingFieldMapTypeConfigsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CustomBookingFieldMapTypeConfigsQuery, CustomBookingFieldMapTypeConfigsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CustomBookingFieldMapTypeConfigsQuery, CustomBookingFieldMapTypeConfigsQueryVariables>(CustomBookingFieldMapTypeConfigsDocument, options);
        }
export type CustomBookingFieldMapTypeConfigsQueryHookResult = ReturnType<typeof useCustomBookingFieldMapTypeConfigsQuery>;
export type CustomBookingFieldMapTypeConfigsLazyQueryHookResult = ReturnType<typeof useCustomBookingFieldMapTypeConfigsLazyQuery>;
export type CustomBookingFieldMapTypeConfigsQueryResult = Apollo.QueryResult<CustomBookingFieldMapTypeConfigsQuery, CustomBookingFieldMapTypeConfigsQueryVariables>;