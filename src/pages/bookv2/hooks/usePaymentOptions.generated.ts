...
export type PaymentOptionsFragment = { laybuy?: boolean | null, braintree?: boolean | null, afterpay?: { merchant_id?: string | null, region?: string | null, order_minimum?: number | null, order_maximum?: number | null } | null };

export type ProductPaymentOptionsQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
  pathname: Types.Scalars['String'];
}>;


export type ProductPaymentOptionsQuery = { bpd_page?: { id: string } | { id: string } | { id: string, paymentOptions: { laybuy?: boolean | null, braintree?: boolean | null, afterpay?: { merchant_id?: string | null, region?: string | null, order_minimum?: number | null, order_maximum?: number | null } | null } } | { id: string } | { id: string } | null };

export const PaymentOptionsFragmentDoc = gql`
  ...
  afterpay {
    ...
    `;
export const ProductPaymentOptionsDocument = gql`
  ...
  bpd_page(host: $host, pathname: $pathname) {
    ...
    ${PaymentOptionsFragmentDoc}`;

/**
 * __useProductPaymentOptionsQuery__
 *
 * To run a query within a React component, call `useProductPaymentOptionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductPaymentOptionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductPaymentOptionsQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useProductPaymentOptionsQuery(baseOptions: Apollo.QueryHookOptions<ProductPaymentOptionsQuery, ProductPaymentOptionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProductPaymentOptionsQuery, ProductPaymentOptionsQueryVariables>(ProductPaymentOptionsDocument, options);
      }
export function useProductPaymentOptionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductPaymentOptionsQuery, ProductPaymentOptionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProductPaymentOptionsQuery, ProductPaymentOptionsQueryVariables>(ProductPaymentOptionsDocument, options);
        }
export type ProductPaymentOptionsQueryHookResult = ReturnType<typeof useProductPaymentOptionsQuery>;
export type ProductPaymentOptionsLazyQueryHookResult = ReturnType<typeof useProductPaymentOptionsLazyQuery>;
export type ProductPaymentOptionsQueryResult = Apollo.QueryResult<ProductPaymentOptionsQuery, ProductPaymentOptionsQueryVariables>;