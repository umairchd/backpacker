...
export type CreatePaymentTokenMutationVariables = Types.Exact<{
  userId?: Types.InputMaybe<Types.Scalars['ID']>;
}>;


export type CreatePaymentTokenMutation = { createPaymentToken?: { value: string, type: string } | null };

export type BookingStatusQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BookingStatusQuery = { booking: { bookingStatus: Types.BookingStatus } };

export type CompleteBookingMutationVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
  paymentToken: Types.Scalars['String'];
}>;


export type CompleteBookingMutation = { completeBooking?: number | null };


export const CreatePaymentTokenDocument = gql`
  ...
  createPaymentToken(userId: $userId) {
    ...
    `;
export type CreatePaymentTokenMutationFn = Apollo.MutationFunction<CreatePaymentTokenMutation, CreatePaymentTokenMutationVariables>;

/**
 * __useCreatePaymentTokenMutation__
 *
 * To run a mutation, you first call `useCreatePaymentTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatePaymentTokenMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createPaymentTokenMutation, { data, loading, error }] = useCreatePaymentTokenMutation({
 *   variables: {
 *      userId: // value for 'userId'
 *   },
 * });
 */
export function useCreatePaymentTokenMutation(baseOptions?: Apollo.MutationHookOptions<CreatePaymentTokenMutation, CreatePaymentTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatePaymentTokenMutation, CreatePaymentTokenMutationVariables>(CreatePaymentTokenDocument, options);
      }
export type CreatePaymentTokenMutationHookResult = ReturnType<typeof useCreatePaymentTokenMutation>;
export type CreatePaymentTokenMutationResult = Apollo.MutationResult<CreatePaymentTokenMutation>;
export type CreatePaymentTokenMutationOptions = Apollo.BaseMutationOptions<CreatePaymentTokenMutation, CreatePaymentTokenMutationVariables>;
export const BookingStatusDocument = gql`
...
/**
 * __useBookingStatusQuery__
 *
 * To run a query within a React component, call `useBookingStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookingStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookingStatusQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function useBookingStatusQuery(baseOptions?: Apollo.QueryHookOptions<BookingStatusQuery, BookingStatusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BookingStatusQuery, BookingStatusQueryVariables>(BookingStatusDocument, options);
      }
export function useBookingStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BookingStatusQuery, BookingStatusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BookingStatusQuery, BookingStatusQueryVariables>(BookingStatusDocument, options);
        }
export type BookingStatusQueryHookResult = ReturnType<typeof useBookingStatusQuery>;
export type BookingStatusLazyQueryHookResult = ReturnType<typeof useBookingStatusLazyQuery>;
export type BookingStatusQueryResult = Apollo.QueryResult<BookingStatusQuery, BookingStatusQueryVariables>;
