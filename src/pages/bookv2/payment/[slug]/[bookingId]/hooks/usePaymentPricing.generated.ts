...
export type PaymentPricingQueryVariables = Types.Exact<{
  bookingUid?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type PaymentPricingQuery = { bookingPricing: { id?: number | null, totalOrderPrice: number, currency: string } };


export const PaymentPricingDocument = gql`
...
/**
 * __usePaymentPricingQuery__
 *
 * To run a query within a React component, call `usePaymentPricingQuery` and pass it any options that fit your needs.
 * When your component renders, `usePaymentPricingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePaymentPricingQuery({
 *   variables: {
 *      bookingUid: // value for 'bookingUid'
 *   },
 * });
 */
export function usePaymentPricingQuery(baseOptions?: Apollo.QueryHookOptions<PaymentPricingQuery, PaymentPricingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PaymentPricingQuery, PaymentPricingQueryVariables>(PaymentPricingDocument, options);
      }
export function usePaymentPricingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PaymentPricingQuery, PaymentPricingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PaymentPricingQuery, PaymentPricingQueryVariables>(PaymentPricingDocument, options);
        }
export type PaymentPricingQueryHookResult = ReturnType<typeof usePaymentPricingQuery>;
export type PaymentPricingLazyQueryHookResult = ReturnType<typeof usePaymentPricingLazyQuery>;
export type PaymentPricingQueryResult = Apollo.QueryResult<PaymentPricingQuery, PaymentPricingQueryVariables>;