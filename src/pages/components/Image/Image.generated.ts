...
export type OptimizedImageQueryVariables = Types.Exact<{
  url: Types.Scalars['String'];
  transform?: Types.InputMaybe<Types.ImageTransformInput>;
}>;


export type OptimizedImageQuery = { transformImage: { id: string, fileName: string, optimized?: string | null } };


export const OptimizedImageDocument = gql`
...
/**
 * __useOptimizedImageQuery__
 *
 * To run a query within a React component, call `useOptimizedImageQuery` and pass it any options that fit your needs.
 * When your component renders, `useOptimizedImageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOptimizedImageQuery({
 *   variables: {
 *      url: // value for 'url'
 ...
 * });
 */
export function useOptimizedImageQuery(baseOptions: Apollo.QueryHookOptions<OptimizedImageQuery, OptimizedImageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OptimizedImageQuery, OptimizedImageQueryVariables>(OptimizedImageDocument, options);
      }
export function useOptimizedImageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OptimizedImageQuery, OptimizedImageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OptimizedImageQuery, OptimizedImageQueryVariables>(OptimizedImageDocument, options);
        }
export type OptimizedImageQueryHookResult = ReturnType<typeof useOptimizedImageQuery>;
export type OptimizedImageLazyQueryHookResult = ReturnType<typeof useOptimizedImageLazyQuery>;
export type OptimizedImageQueryResult = Apollo.QueryResult<OptimizedImageQuery, OptimizedImageQueryVariables>;