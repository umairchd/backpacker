...
export type MiddlewareRedirectOrRewriteQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
  pathname: Types.Scalars['String'];
}>;


export type MiddlewareRedirectOrRewriteQuery = { redirect?: { newUrl: string, status: number } | null, page?: { __typename: 'BPD_ListPage' } | { __typename: 'BPD_NonPage' } | { __typename: 'BPD_ProductPage' } | { __typename: 'BPD_RegionPage' } | { __typename: 'BPD_StaticPage' } | null };

export type MiddlewareChannelByHostQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
}>;


export type MiddlewareChannelByHostQuery = { channel: { id: string, theme: string, key: string, url: string } };


export const MiddlewareRedirectOrRewriteDocument = gql`
...
/**
 * __useMiddlewareRedirectOrRewriteQuery__
 *
 * To run a query within a React component, call `useMiddlewareRedirectOrRewriteQuery` and pass it any options that fit your needs.
 * When your component renders, `useMiddlewareRedirectOrRewriteQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMiddlewareRedirectOrRewriteQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useMiddlewareRedirectOrRewriteQuery(baseOptions: Apollo.QueryHookOptions<MiddlewareRedirectOrRewriteQuery, MiddlewareRedirectOrRewriteQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MiddlewareRedirectOrRewriteQuery, MiddlewareRedirectOrRewriteQueryVariables>(MiddlewareRedirectOrRewriteDocument, options);
      }
export function useMiddlewareRedirectOrRewriteLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MiddlewareRedirectOrRewriteQuery, MiddlewareRedirectOrRewriteQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MiddlewareRedirectOrRewriteQuery, MiddlewareRedirectOrRewriteQueryVariables>(MiddlewareRedirectOrRewriteDocument, options);
        }
export type MiddlewareRedirectOrRewriteQueryHookResult = ReturnType<typeof useMiddlewareRedirectOrRewriteQuery>;
export type MiddlewareRedirectOrRewriteLazyQueryHookResult = ReturnType<typeof useMiddlewareRedirectOrRewriteLazyQuery>;
export type MiddlewareRedirectOrRewriteQueryResult = Apollo.QueryResult<MiddlewareRedirectOrRewriteQuery, MiddlewareRedirectOrRewriteQueryVariables>;
export const MiddlewareChannelByHostDocument = gql`
...
/**
 * __useMiddlewareChannelByHostQuery__
 *
 * To run a query within a React component, call `useMiddlewareChannelByHostQuery` and pass it any options that fit your needs.
 * When your component renders, `useMiddlewareChannelByHostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMiddlewareChannelByHostQuery({
 *   variables: {
 *      host: // value for 'host'
 *   },
 * });
 */
export function useMiddlewareChannelByHostQuery(baseOptions: Apollo.QueryHookOptions<MiddlewareChannelByHostQuery, MiddlewareChannelByHostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MiddlewareChannelByHostQuery, MiddlewareChannelByHostQueryVariables>(MiddlewareChannelByHostDocument, options);
      }
export function useMiddlewareChannelByHostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MiddlewareChannelByHostQuery, MiddlewareChannelByHostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MiddlewareChannelByHostQuery, MiddlewareChannelByHostQueryVariables>(MiddlewareChannelByHostDocument, options);
        }
export type MiddlewareChannelByHostQueryHookResult = ReturnType<typeof useMiddlewareChannelByHostQuery>;
export type MiddlewareChannelByHostLazyQueryHookResult = ReturnType<typeof useMiddlewareChannelByHostLazyQuery>;
export type MiddlewareChannelByHostQueryResult = Apollo.QueryResult<MiddlewareChannelByHostQuery, MiddlewareChannelByHostQueryVariables>;