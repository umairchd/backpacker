...
import { CountryCardV2FragmentDoc, CategoryCardV2FragmentDoc, CityCardV2FragmentDoc, CategoryCardFragmentDoc } from '../../pages/components/queries/queries.generated';
...
/**
 * __useAllProductStatisticsQuery__
 *
 * To run a query within a React component, call `useAllProductStatisticsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllProductStatisticsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllProductStatisticsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllProductStatisticsQuery(baseOptions?: Apollo.QueryHookOptions<AllProductStatisticsQuery, AllProductStatisticsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProductStatisticsQuery, AllProductStatisticsQueryVariables>(AllProductStatisticsDocument, options);
      }
export function useAllProductStatisticsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProductStatisticsQuery, AllProductStatisticsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProductStatisticsQuery, AllProductStatisticsQueryVariables>(AllProductStatisticsDocument, options);
        }
export type AllProductStatisticsQueryHookResult = ReturnType<typeof useAllProductStatisticsQuery>;
export type AllProductStatisticsLazyQueryHookResult = ReturnType<typeof useAllProductStatisticsLazyQuery>;
export type AllProductStatisticsQueryResult = Apollo.QueryResult<AllProductStatisticsQuery, AllProductStatisticsQueryVariables>;