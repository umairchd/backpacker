...
import { CategoryCardFragmentDoc } from '../../pages/components/queries/queries.generated';
...
/**
 * __useSharedChannelByHostQuery__
 *
 * To run a query within a React component, call `useSharedChannelByHostQuery` and pass it any options that fit your needs.
 * When your component renders, `useSharedChannelByHostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSharedChannelByHostQuery({
 *   variables: {
 *      host: // value for 'host'
 *   },
 * });
 */
export function useSharedChannelByHostQuery(baseOptions: Apollo.QueryHookOptions<SharedChannelByHostQuery, SharedChannelByHostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SharedChannelByHostQuery, SharedChannelByHostQueryVariables>(SharedChannelByHostDocument, options);
      }
export function useSharedChannelByHostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SharedChannelByHostQuery, SharedChannelByHostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SharedChannelByHostQuery, SharedChannelByHostQueryVariables>(SharedChannelByHostDocument, options);
        }
export type SharedChannelByHostQueryHookResult = ReturnType<typeof useSharedChannelByHostQuery>;
export type SharedChannelByHostLazyQueryHookResult = ReturnType<typeof useSharedChannelByHostLazyQuery>;
export type SharedChannelByHostQueryResult = Apollo.QueryResult<SharedChannelByHostQuery, SharedChannelByHostQueryVariables>;