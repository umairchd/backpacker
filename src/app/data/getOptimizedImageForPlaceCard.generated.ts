...
export type PlaceImageFragment = { id: string, fileName: string, medium3200?: string | null, medium1100?: string | null, medium800?: string | null };

export type PlaceImageQueryVariables = Types.Exact<{
  url: Types.Scalars['String'];
}>;


export type PlaceImageQuery = { transformImage: { id: string, fileName: string, medium3200?: string | null, medium1100?: string | null, medium800?: string | null } };

export const PlaceImageFragmentDoc = gql`
  ...
  fileName
    ...
    `;
export const PlaceImageDocument = gql`
    query PlaceImage($url: String!) {
  transformImage: imgTransformImage(url: $url) {
    ...PlaceImage
  }
}
    ${PlaceImageFragmentDoc}`;

/**
 * __usePlaceImageQuery__
 *
 * To run a query within a React component, call `usePlaceImageQuery` and pass it any options that fit your needs.
 * When your component renders, `usePlaceImageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePlaceImageQuery({
 *   variables: {
 *      url: // value for 'url'
 *   },
 * });
 */
export function usePlaceImageQuery(baseOptions: Apollo.QueryHookOptions<PlaceImageQuery, PlaceImageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PlaceImageQuery, PlaceImageQueryVariables>(PlaceImageDocument, options);
      }
export function usePlaceImageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PlaceImageQuery, PlaceImageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PlaceImageQuery, PlaceImageQueryVariables>(PlaceImageDocument, options);
        }
export type PlaceImageQueryHookResult = ReturnType<typeof usePlaceImageQuery>;
export type PlaceImageLazyQueryHookResult = ReturnType<typeof usePlaceImageLazyQuery>;
export type PlaceImageQueryResult = Apollo.QueryResult<PlaceImageQuery, PlaceImageQueryVariables>;