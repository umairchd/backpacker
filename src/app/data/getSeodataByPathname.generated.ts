...
export type SeodataByPathnameQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
  pathname: Types.Scalars['String'];
}>;


export type SeodataByPathnameQuery = { seoData: { id: string, openGraph_title?: string | null, openGraph_type?: string | null, openGraph_url?: string | null, openGraph_description?: string | null, twitterCard_card?: string | null, twitterCard_title?: string | null, twitterCard_description?: string | null, seoConfig_title?: string | null, seoConfig_description?: string | null, seoConfig_keywords?: string | null, openGraph_site_name?: string | null, twitterCard_site?: string | null, seoConfig_schema?: string | null, canonical_url?: string | null, amp_url?: string | null, author_title?: string | null, rss_title?: string | null, rss_xml?: string | null, language?: string | null, noindex?: boolean | null, canonical_host?: string | null, openGraphImage?: { id: string, fileName: string } | null, twitterCardImage?: { id: string, fileName: string } | null } };


export const SeodataByPathnameDocument = gql`
...
/**
 * __useSeodataByPathnameQuery__
 *
 * To run a query within a React component, call `useSeodataByPathnameQuery` and pass it any options that fit your needs.
 * When your component renders, `useSeodataByPathnameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSeodataByPathnameQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useSeodataByPathnameQuery(baseOptions: Apollo.QueryHookOptions<SeodataByPathnameQuery, SeodataByPathnameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SeodataByPathnameQuery, SeodataByPathnameQueryVariables>(SeodataByPathnameDocument, options);
      }
export function useSeodataByPathnameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SeodataByPathnameQuery, SeodataByPathnameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SeodataByPathnameQuery, SeodataByPathnameQueryVariables>(SeodataByPathnameDocument, options);
        }
export type SeodataByPathnameQueryHookResult = ReturnType<typeof useSeodataByPathnameQuery>;
export type SeodataByPathnameLazyQueryHookResult = ReturnType<typeof useSeodataByPathnameLazyQuery>;
export type SeodataByPathnameQueryResult = Apollo.QueryResult<SeodataByPathnameQuery, SeodataByPathnameQueryVariables>;