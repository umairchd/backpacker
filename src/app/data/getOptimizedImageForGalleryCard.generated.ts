...
import { BlogImageFragmentDoc } from './getOptimizedImageForBlogCard.generated';
...
export type GalleryImageQueryVariables = Types.Exact<{
  url: Types.Scalars['String'];
}>;


export type GalleryImageQuery = { transformImage: { id: string, altText?: string | null, fileName: string, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null, blog?: string | null, regionCategoryCard?: string | null } };


export const GalleryImageDocument = gql`
...
${BlogImageFragmentDoc}`;

/**
 * __useGalleryImageQuery__
 *
 * To run a query within a React component, call `useGalleryImageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGalleryImageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useGalleryImageQuery(baseOptions: Apollo.QueryHookOptions<GalleryImageQuery, GalleryImageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GalleryImageQuery, GalleryImageQueryVariables>(GalleryImageDocument, options);
      }
export function useGalleryImageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GalleryImageQuery, GalleryImageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GalleryImageQuery, GalleryImageQueryVariables>(GalleryImageDocument, options);
        }
export type GalleryImageQueryHookResult = ReturnType<typeof useGalleryImageQuery>;
export type GalleryImageLazyQueryHookResult = ReturnType<typeof useGalleryImageLazyQuery>;
export type GalleryImageQueryResult = Apollo.QueryResult<GalleryImageQuery, GalleryImageQueryVariables>;