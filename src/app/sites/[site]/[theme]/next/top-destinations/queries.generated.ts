...
import { HeroImageFragmentDoc, ProductCardFragmentDoc } from '../../../../../../pages/components/queries/queries.generated';
...
export type TopDestinationPageQueryVariables = Types.Exact<{
  backgroundImage: Types.Scalars['String'];
}>;


export type TopDestinationPageQuery = { backgroundImage: { id: string, altText?: string | null, fileName: string, top3000?: string | null, top2400?: string | null, top1600?: string | null, top1400?: string | null, top1200?: string | null, top1140?: string | null, top1024?: string | null, top800?: string | null, top768?: string | null, top500?: string | null, top480?: string | null } };


export const TopDestinationPageDocument = gql`
...
/**
 * __useTopDestinationPageQuery__
 *
 * To run a query within a React component, call `useTopDestinationPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopDestinationPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopDestinationPageQuery({
 *   variables: {
 *      backgroundImage: // value for 'backgroundImage'
 *   },
 * });
 */
export function useTopDestinationPageQuery(baseOptions: Apollo.QueryHookOptions<TopDestinationPageQuery, TopDestinationPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TopDestinationPageQuery, TopDestinationPageQueryVariables>(TopDestinationPageDocument, options);
      }
export function useTopDestinationPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TopDestinationPageQuery, TopDestinationPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TopDestinationPageQuery, TopDestinationPageQueryVariables>(TopDestinationPageDocument, options);
        }
export type TopDestinationPageQueryHookResult = ReturnType<typeof useTopDestinationPageQuery>;
export type TopDestinationPageLazyQueryHookResult = ReturnType<typeof useTopDestinationPageLazyQuery>;
export type TopDestinationPageQueryResult = Apollo.QueryResult<TopDestinationPageQuery, TopDestinationPageQueryVariables>;