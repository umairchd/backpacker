...
export type RegionPageFragment = { __typename: 'BPD_RegionPage', id: string, template: string, content?: string | null, title?: string | null };

export type AppRouterRegionPageQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
  pathname: Types.Scalars['String'];
}>;


export type AppRouterRegionPageQuery = { page?: { __typename: 'BPD_ListPage', id: string, template: string } | { __typename: 'BPD_NonPage', id: string, template: string } | { __typename: 'BPD_ProductPage', id: string, template: string } | { __typename: 'BPD_RegionPage', id: string, template: string, content?: string | null, title?: string | null } | { __typename: 'BPD_StaticPage', id: string, template: string } | null };

export const RegionPageFragmentDoc = gql`
  ...
  title
    ...
    `;
export const AppRouterRegionPageDocument = gql`
...
/**
 * __useAppRouterRegionPageQuery__
 *
 * To run a query within a React component, call `useAppRouterRegionPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useAppRouterRegionPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAppRouterRegionPageQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useAppRouterRegionPageQuery(baseOptions: Apollo.QueryHookOptions<AppRouterRegionPageQuery, AppRouterRegionPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AppRouterRegionPageQuery, AppRouterRegionPageQueryVariables>(AppRouterRegionPageDocument, options);
      }
export function useAppRouterRegionPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AppRouterRegionPageQuery, AppRouterRegionPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AppRouterRegionPageQuery, AppRouterRegionPageQueryVariables>(AppRouterRegionPageDocument, options);
        }
export type AppRouterRegionPageQueryHookResult = ReturnType<typeof useAppRouterRegionPageQuery>;
export type AppRouterRegionPageLazyQueryHookResult = ReturnType<typeof useAppRouterRegionPageLazyQuery>;
export type AppRouterRegionPageQueryResult = Apollo.QueryResult<AppRouterRegionPageQuery, AppRouterRegionPageQueryVariables>;