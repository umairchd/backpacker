...
export type StaticPageFragment = { __typename: 'BPD_StaticPage', id: string, template: string, content?: string | null, title?: string | null, subTemplate?: string | null, menu?: Array<{ id: string, name?: string | null, uri: { __typename: 'BPD_ExternalUri', url?: string | null } | { __typename: 'BPD_Uri', url?: string | null } }> | null };

export type AppRouterStaticPageQueryVariables = Types.Exact<{
  host: Types.Scalars['String'];
  pathname: Types.Scalars['String'];
}>;


export type AppRouterStaticPageQuery = { page?: { __typename: 'BPD_ListPage', id: string, template: string } | { __typename: 'BPD_NonPage', id: string, template: string } | { __typename: 'BPD_ProductPage', id: string, template: string } | { __typename: 'BPD_RegionPage', id: string, template: string } | { __typename: 'BPD_StaticPage', id: string, template: string, content?: string | null, title?: string | null, subTemplate?: string | null, menu?: Array<{ id: string, name?: string | null, uri: { __typename: 'BPD_ExternalUri', url?: string | null } | { __typename: 'BPD_Uri', url?: string | null } }> | null } | null };
...
export const StaticPageFragmentDoc = gql`
  ...
  menu {
    ...
    `;
export const AppRouterStaticPageDocument = gql`
...
/**
 * __useAppRouterStaticPageQuery__
 *
 * To run a query within a React component, call `useAppRouterStaticPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useAppRouterStaticPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAppRouterStaticPageQuery({
 *   variables: {
 *      host: // value for 'host'
 ...
 * });
 */
export function useAppRouterStaticPageQuery(baseOptions: Apollo.QueryHookOptions<AppRouterStaticPageQuery, AppRouterStaticPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AppRouterStaticPageQuery, AppRouterStaticPageQueryVariables>(AppRouterStaticPageDocument, options);
      }
export function useAppRouterStaticPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AppRouterStaticPageQuery, AppRouterStaticPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AppRouterStaticPageQuery, AppRouterStaticPageQueryVariables>(AppRouterStaticPageDocument, options);
        }
export type AppRouterStaticPageQueryHookResult = ReturnType<typeof useAppRouterStaticPageQuery>;
export type AppRouterStaticPageLazyQueryHookResult = ReturnType<typeof useAppRouterStaticPageLazyQuery>;
export type AppRouterStaticPageQueryResult = Apollo.QueryResult<AppRouterStaticPageQuery, AppRouterStaticPageQueryVariables>;