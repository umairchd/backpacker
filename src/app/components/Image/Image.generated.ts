...
export type AppRouterOptimizedImageQueryVariables = Types.Exact<{
  url: Types.Scalars['String'];
  transform?: Types.InputMaybe<Types.ImageTransformInput>;
}>;


export type AppRouterOptimizedImageQuery = { transformImage: { id: string, fileName: string, optimized?: string | null } };


export const AppRouterOptimizedImageDocument = gql`
    query AppRouterOptimizedImage($url: String!, $transform: ImageTransformInput) {
...
/**
 * __useAppRouterOptimizedImageQuery__
 *
 * To run a query within a React component, call `useAppRouterOptimizedImageQuery` and pass it any options that fit your needs.
 * When your component renders, `useAppRouterOptimizedImageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAppRouterOptimizedImageQuery({
 *   variables: {
 *      url: // value for 'url'
 *      transform: // value for 'transform'
 *   },
 * });
 */
export function useAppRouterOptimizedImageQuery(baseOptions: Apollo.QueryHookOptions<AppRouterOptimizedImageQuery, AppRouterOptimizedImageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AppRouterOptimizedImageQuery, AppRouterOptimizedImageQueryVariables>(AppRouterOptimizedImageDocument, options);
      }
export function useAppRouterOptimizedImageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AppRouterOptimizedImageQuery, AppRouterOptimizedImageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AppRouterOptimizedImageQuery, AppRouterOptimizedImageQueryVariables>(AppRouterOptimizedImageDocument, options);
        }
export type AppRouterOptimizedImageQueryHookResult = ReturnType<typeof useAppRouterOptimizedImageQuery>;
export type AppRouterOptimizedImageLazyQueryHookResult = ReturnType<typeof useAppRouterOptimizedImageLazyQuery>;
export type AppRouterOptimizedImageQueryResult = Apollo.QueryResult<AppRouterOptimizedImageQuery, AppRouterOptimizedImageQueryVariables>;